...
(function () {
  var mobileMenuMedia = window.matchMedia('(max-width: 1200px)');
  ...
  function initNavDropdownAria() {
    ...
    dropdowns.forEach(function (dropdown) {
      ...
      function submenuIsVisible() {
        if (!mobileMenuMedia.matches && dropdown.classList.contains('is-submenu-dismissed')) return false;
      ...
      dropdown.addEventListener('keydown', function (event) {
        if (event.key !== 'Escape' || mobileMenuMedia.matches || !submenuIsVisible()) return;
      ...
      window.addEventListener('resize', function () {
        if (mobileMenuMedia.matches) dropdown.classList.remove('is-submenu-dismissed');
        scheduleSync();
      });
      scheduleSync();
    });
  ...
  // BEGIN LANGUAGE MENU DATA
  // Generated by scripts/sync-language-menus.py from existing page canonicals.
  var siteLanguages = [["de", "Deutsch"], ["en", "English"], ["it", "Italiano"], ["fr", "Français"], ["nl", "Nederlands"], ["es", "Español"], ["tr", "Türkçe"], ["pl", "Polski"], ["ru", "Русский"], ["cs", "Čeština"], ["ja", "日本語"], ["ko", "한국어"], ["id", "Bahasa Indonesia"], ["hi", "हिंदी"], ["ar", "العربية"], ["pt-PT", "Português (Portugal)"]];
  var languageRoutes = {
    "/": {"de": "/", "en": "/en/", "it": "/it/", "fr": "/fr/", "nl": "/nl/", "es": "/es/", "tr": "/tr/", "pl": "/pl/", "ru": "/ru/", "cs": "/cs/", "ja": "/ja/", "ko": "/ko/", "id": "/id/", "hi": "/hi/", "ar": "/ar/", "pt-PT": "/pt/"},
    "/datenschutz": {"de": "/datenschutz", "en": "/en/privacy", "it": "/it/privacy-policy", "fr": "/fr/politique-de-confidentialite", "nl": "/nl/privacyverklaring", "es": "/es/politica-de-privacidad", "tr": "/tr/gizlilik", "pl": "/pl/polityka-prywatnosci", "ru": "/ru/politika-konfidentsialnosti/", "cs": "/cs/datenschutz", "ja": "/ja/datenschutz", "ko": "/ko/datenschutz", "id": "/id/kebijakan-privasi", "hi": "/hi/datenschutz", "ar": "/ar/datenschutz", "pt-PT": "/pt/politica-de-privacidade"},
    "/erfahrungsberichte": {"de": "/erfahrungsberichte", "en": "/en/testimonials", "it": "/it/testimonianze", "fr": "/fr/temoignages", "nl": "/nl/ervaringen", "es": "/es/testimonios", "tr": "/tr/deneyim-yazilari", "pl": "/pl/historie-czytelnikow", "ru": "/ru/otzyvy/", "cs": "/cs/erfahrungsberichte", "ja": "/ja/erfahrungsberichte", "ko": "/ko/erfahrungsberichte", "id": "/id/kisah-pengalaman", "hi": "/hi/erfahrungsberichte", "ar": "/ar/erfahrungsberichte", "pt-PT": "/pt/relatos-de-experiencias"},
    "/faq": {"de": "/faq", "en": "/en/faq", "it": "/it/domande-frequenti", "fr": "/fr/faq", "nl": "/nl/veelgestelde-vragen", "es": "/es/preguntas-frecuentes", "pl": "/pl/najczestsze-pytania", "ru": "/ru/chastye-voprosy/", "cs": "/cs/faq", "ja": "/ja/faq", "ko": "/ko/faq", "id": "/id/faq", "hi": "/hi/faq", "ar": "/ar/faq", "pt-PT": "/pt/faq"},
    "/impressum": {"de": "/impressum", "en": "/en/imprint", "it": "/it/note-legali", "fr": "/fr/mentions-legales", "nl": "/nl/colofon", "es": "/es/aviso-legal", "tr": "/tr/kunye", "pl": "/pl/informacje-prawne", "ru": "/ru/pravovaya-informatsiya/", "cs": "/cs/impressum", "ja": "/ja/impressum", "ko": "/ko/impressum", "id": "/id/informasi-hukum", "hi": "/hi/impressum", "ar": "/ar/impressum", "pt-PT": "/pt/informacao-legal"},
    "/kontakt": {"de": "/kontakt", "en": "/en/contact", "it": "/it/contatti", "fr": "/fr/contact", "nl": "/nl/contact", "es": "/es/contacto", "tr": "/tr/iletisim", "pl": "/pl/kontakt", "ru": "/ru/kontakty/", "cs": "/cs/kontakt", "ja": "/ja/kontakt", "ko": "/ko/kontakt", "id": "/id/kontak", "hi": "/hi/kontakt", "ar": "/ar/kontakt", "pt-PT": "/pt/contacto"},
    "/laermbedingter-tinnitus": {"de": "/laermbedingter-tinnitus", "en": "/en/noise-induced-tinnitus", "it": "/it/acufene-da-trauma-acustico", "fr": "/fr/acouphenes-et-bruit", "nl": "/nl/tinnitus-door-lawaai", "es": "/es/acufenos-por-ruido", "tr": "/tr/gurultuye-bagli-tinnitus", "pl": "/pl/szumy-uszne-od-halasu", "ru": "/ru/tinnitus-ot-shuma/", "cs": "/cs/laermbedingter-tinnitus", "ja": "/ja/laermbedingter-tinnitus", "ko": "/ko/laermbedingter-tinnitus", "id": "/id/tinnitus-akibat-kebisingan", "hi": "/hi/laermbedingter-tinnitus", "ar": "/ar/laermbedingter-tinnitus", "pt-PT": "/pt/acufenos-causados-pelo-ruido"},
    "/medikamente-gifte-tinnitus": {"de": "/medikamente-gifte-tinnitus", "en": "/en/medication-toxin-tinnitus", "it": "/it/acufene-da-farmaci-ototossici", "fr": "/fr/acouphenes-et-medicaments", "nl": "/nl/tinnitus-door-medicijnen", "es": "/es/acufenos-por-medicamentos-y-toxicos", "tr": "/tr/ilac-ve-toksin-kaynakli-tinnitus", "pl": "/pl/szumy-uszne-po-lekach-i-toksynach", "ru": "/ru/tinnitus-ot-lekarstv-i-toksinov/", "cs": "/cs/medikamente-gifte-tinnitus", "ja": "/ja/medikamente-gifte-tinnitus", "ko": "/ko/medikamente-gifte-tinnitus", "id": "/id/tinnitus-akibat-obat-dan-zat-beracun", "hi": "/hi/medikamente-gifte-tinnitus", "ar": "/ar/medikamente-gifte-tinnitus", "pt-PT": "/pt/acufenos-medicamentos-substancias-toxicas"},
    "/mein-loesungsansatz": {"de": "/mein-loesungsansatz", "en": "/en/my-approach", "it": "/it/acufene-il-mio-approccio", "fr": "/fr/ma-demarche-acouphenes", "nl": "/nl/mijn-aanpak", "es": "/es/mi-enfoque", "tr": "/tr/cozum-yaklasimim", "pl": "/pl/moje-podejscie", "ru": "/ru/moy-podhod/", "cs": "/cs/mein-loesungsansatz", "ja": "/ja/mein-loesungsansatz", "ko": "/ko/mein-loesungsansatz", "id": "/id/pendekatan-saya", "hi": "/hi/mein-loesungsansatz", "ar": "/ar/mein-loesungsansatz", "pt-PT": "/pt/a-minha-abordagem"},
    "/meine-geschichte-teil-1": {"de": "/meine-geschichte-teil-1", "en": "/en/my-story-part-1", "it": "/it/la-mia-storia-parte-1", "fr": "/fr/mon-histoire-partie-1", "nl": "/nl/mijn-verhaal-deel-1", "es": "/es/mi-historia-parte-1", "tr": "/tr/hikayem-bolum-1", "pl": "/pl/moja-historia-czesc-1", "ru": "/ru/moya-istoriya-chast-1/", "cs": "/cs/meine-geschichte-teil-1", "ja": "/ja/meine-geschichte-teil-1", "ko": "/ko/meine-geschichte-teil-1", "id": "/id/kisah-tinnitus-saya-bagian-1", "hi": "/hi/meine-geschichte-teil-1", "ar": "/ar/meine-geschichte-teil-1", "pt-PT": "/pt/a-minha-historia-parte-1"},
    "/meine-geschichte-teil-2": {"de": "/meine-geschichte-teil-2", "en": "/en/my-story-part-2", "it": "/it/la-mia-storia-parte-2", "fr": "/fr/mon-histoire-partie-2", "nl": "/nl/mijn-verhaal-deel-2", "es": "/es/mi-historia-parte-2", "tr": "/tr/hikayem-bolum-2", "pl": "/pl/moja-historia-czesc-2", "ru": "/ru/moya-istoriya-chast-2/", "cs": "/cs/meine-geschichte-teil-2", "ja": "/ja/meine-geschichte-teil-2", "ko": "/ko/meine-geschichte-teil-2", "id": "/id/kisah-tinnitus-saya-bagian-2", "hi": "/hi/meine-geschichte-teil-2", "ar": "/ar/meine-geschichte-teil-2", "pt-PT": "/pt/a-minha-historia-parte-2"},
    "/produkte": {"de": "/produkte", "en": "/en/products", "it": "/it/prodotti", "fr": "/fr/produits", "nl": "/nl/producten", "es": "/es/productos", "tr": "/tr/urunler", "pl": "/pl/produkty", "ru": "/ru/moi-produkty/", "cs": "/cs/produkte", "ja": "/ja/produkte", "ko": "/ko/produkte", "id": "/id/produk", "hi": "/hi/produkte", "ar": "/ar/produkte", "pt-PT": "/pt/produtos"},
    "/stressbedingter-tinnitus": {"de": "/stressbedingter-tinnitus", "en": "/en/stress-related-tinnitus", "it": "/it/acufene-da-stress", "fr": "/fr/acouphenes-et-stress", "nl": "/nl/tinnitus-door-stress", "es": "/es/acufenos-por-estres", "tr": "/tr/strese-bagli-tinnitus", "pl": "/pl/szumy-uszne-od-stresu", "ru": "/ru/tinnitus-ot-stressa/", "cs": "/cs/stressbedingter-tinnitus", "ja": "/ja/stressbedingter-tinnitus", "ko": "/ko/stressbedingter-tinnitus", "id": "/id/tinnitus-akibat-stres", "hi": "/hi/stressbedingter-tinnitus", "ar": "/ar/stressbedingter-tinnitus", "pt-PT": "/pt/acufenos-causados-pelo-stresse"},
    "/tinnitus-geheilt-erfahrungsbericht": {"de": "/tinnitus-geheilt-erfahrungsbericht", "en": "/en/tinnitus-recovery-my-story", "it": "/it/acufene-la-mia-esperienza", "fr": "/fr/acouphenes-mon-temoignage", "nl": "/nl/tinnitus-genezen-mijn-verhaal", "es": "/es/mi-historia-con-los-acufenos", "tr": "/tr/tinnitus-iyilesme-hikayem", "pl": "/pl/szumy-uszne-moja-historia", "ru": "/ru/moya-istoriya-o-tinnituse/", "cs": "/cs/tinnitus-geheilt-erfahrungsbericht", "ja": "/ja/tinnitus-geheilt-erfahrungsbericht", "ko": "/ko/tinnitus-geheilt-erfahrungsbericht", "id": "/id/tinnitus-sembuh-kisah-saya", "hi": "/hi/tinnitus-geheilt-erfahrungsbericht", "ar": "/ar/tinnitus-geheilt-erfahrungsbericht", "pt-PT": "/pt/o-meu-colapso-com-acufenos"},
    "/wissenschaftliche-quellen": {"de": "/wissenschaftliche-quellen", "en": "/en/scientific-sources", "it": "/it/fonti-scientifiche", "fr": "/fr/sources-scientifiques", "nl": "/nl/wetenschappelijke-bronnen", "es": "/es/fuentes-cientificas", "tr": "/tr/bilimsel-kaynaklar", "pl": "/pl/zrodla-naukowe", "ru": "/ru/nauchnye-istochniki/", "cs": "/cs/wissenschaftliche-quellen", "ja": "/ja/wissenschaftliche-quellen", "ko": "/ko/wissenschaftliche-quellen", "id": "/id/sumber-ilmiah", "hi": "/hi/wissenschaftliche-quellen", "ar": "/ar/wissenschaftliche-quellen", "pt-PT": "/pt/fontes-cientificas"}
  };
  ...
  function ensureLanguageOptions() {
    var currentPath = normalizeLanguagePath(window.location.pathname);
    var currentLanguage = document.documentElement.lang.toLowerCase().split('-')[0];
    var pageGroup = Object.keys(languageRoutes).find(function (group) {
      return Object.keys(languageRoutes[group]).some(function (language) {
        return normalizeLanguagePath(languageRoutes[group][language]) === currentPath;
      });
    });

    document.querySelectorAll('details.lang-switch .lang-menu').forEach(function (menu) {
      // A new page can supply its German counterpart before the shared map is rebuilt.
      var germanLink = menu.querySelector('a[hreflang="de"]');
      var group = pageGroup;
      if (!group && germanLink) {
        try {
          group = normalizeLanguagePath(new URL(germanLink.getAttribute('href'), window.location.origin).pathname);
        } catch (error) {
          group = '/';
        }
      }
      var routes = languageRoutes[group] || {};
      var existingLinks = {};
      menu.querySelectorAll('a[hreflang]').forEach(function (link) {
        existingLinks[link.getAttribute('hreflang')] = link;
      });
      var fragment = document.createDocumentFragment();
      siteLanguages.forEach(function (language) {
        var code = language[0];
        var link = existingLinks[code] || document.createElement('a');
        var route = routes[code];
        // Preserve a newly published sibling explicitly supplied by this page.
        if (!route && existingLinks[code] && !link.hasAttribute('data-language-home')) {
          route = link.getAttribute('href');
        }
        var isHomeFallback = !route;
        route = route || languageRoutes['/'][code];
        link.setAttribute('href', route);
        link.setAttribute('hreflang', code);
        link.classList.toggle('active', code.toLowerCase().split('-')[0] === currentLanguage);
        link.removeAttribute('aria-current');
        if (normalizeLanguagePath(route) === currentPath) link.setAttribute('aria-current', 'page');
        if (isHomeFallback) link.setAttribute('data-language-home', 'true');
        else link.removeAttribute('data-language-home');

        var languageCode = document.createElement('span');
        languageCode.className = 'lang-code';
        languageCode.setAttribute('dir', 'ltr');
        languageCode.textContent = code.slice(0, 2).toUpperCase();
        var languageName = document.createElement('span');
        languageName.className = 'lang-name';
        languageName.setAttribute('lang', code);
        languageName.setAttribute('dir', code === 'ar' ? 'rtl' : 'ltr');
        languageName.textContent = language[1];
        link.replaceChildren(languageCode, languageName);
  ...
  function initHeaderControls() {
    ...
    window.addEventListener('resize', function () {
      if (!mobileMenuMedia.matches) closeMobileMenu(false);
    });
  }
...
(function() {
  ...
  var initVoiceflow = function() {
    ...
    // Load Voiceflow script bundle only after opt-in.
    (function(d,t){
  ...
  "id": {
    ...
    "closeDialog": "Tutup",
    "privacyDescription": "Sebelum kami dapat melanjutkan percakapanmu, kami meminta kamu untuk membaca dan menyetujui kebijakan privasi kami. Kebijakan tersebut menjelaskan bagaimana kami memproses dan melindungi data pribadimu dalam layanan kami.",
  ...
  var getVoiceflowConsent = function() {
    try {
      return window.localStorage.getItem(VF_CONSENT_KEY);
    } catch (err) {
      return null;
    }
  };

  var setVoiceflowConsent = function(value) {
    try {
      window.localStorage.setItem(VF_CONSENT_KEY, value);
    } catch (err) {}
  };

  var consentCopy = function() {
    var lang = (document.documentElement.lang || 'de').toLowerCase();
    if (lang.indexOf('en') === 0) {
      return {
        title: 'Optional chat',
        text: 'The chat loads scripts from Voiceflow only after you opt in. No Voiceflow request is sent beforehand.',
        accept: 'Load chat',
        decline: 'Not now',
    ...
    return {
      title: 'Optionaler Chat',
      text: 'Der Chat lädt Skripte von Voiceflow erst nach deiner Einwilligung. Vorher geht keine Anfrage an Voiceflow.',
      accept: 'Chat laden',
      decline: 'Nicht jetzt',
      privacy: 'Datenschutz',
  ...
  var removeConsentUi = function() {
    var panel = document.getElementById('vf-consent');
    if (panel && panel.parentNode) panel.parentNode.removeChild(panel);
    var launcher = document.getElementById('vf-consent-launcher');
    if (launcher && launcher.parentNode) launcher.parentNode.removeChild(launcher);
  };

  var showConsentLauncher = function() {
    if (document.getElementById('vf-consent-launcher') || voiceflowLoaded) return;
    var copy = consentCopy();
    var btn = document.createElement('button');
    btn.id = 'vf-consent-launcher';
    btn.type = 'button';
    btn.className = 'vf-consent-launcher';
    btn.setAttribute('aria-label', copy.reopen);
    btn.textContent = copy.reopen;
    btn.addEventListener('click', function() {
  ...
  var showConsentPanel = function() {
    if (document.getElementById('vf-consent') || voiceflowLoaded) return;
    var copy = consentCopy();
    var wrap = document.createElement('div');
    wrap.id = 'vf-consent';
    wrap.className = 'vf-consent';
    wrap.setAttribute('role', 'dialog');
    wrap.setAttribute('aria-modal', 'false');
    wrap.setAttribute('aria-labelledby', 'vf-consent-title');
    wrap.innerHTML =
      '<p class="vf-consent-title" id="vf-consent-title">' + copy.title + '</p>' +
      '<p class="vf-consent-text">' + copy.text + '</p>' +
      '<div class="vf-consent-actions">' +
        '<button type="button" class="vf-consent-accept" data-vf-accept>' + copy.accept + '</button>' +
        '<button type="button" class="vf-consent-decline" data-vf-decline>' + copy.decline + '</button>' +
      '</div>' +
      '<a class="vf-consent-privacy" href="' + copy.privacyHref + '">' + copy.privacy + '</a>';
    wrap.querySelector('[data-vf-accept]').addEventListener('click', function() {
      setVoiceflowConsent('accepted');
      removeConsentUi();
      initVoiceflow();
    });
    wrap.querySelector('[data-vf-decline]').addEventListener('click', function() {
      setVoiceflowConsent('declined');
      removeConsentUi();
      showConsentLauncher();
    });
  ...
  if (getVoiceflowConsent() === 'accepted') {
    initVoiceflow();
  } else if (getVoiceflowConsent() === 'declined') {
    showConsentLauncher();
  } else {
    showConsentPanel();
  }
